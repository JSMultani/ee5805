...
/*
 * base addrs of Flash and SRAM memories
 */
#define FLASH_BASEADDR		0x08000000U		// aka "Main Memory"
#define SRAM1_BASEADDR		0x20000000U		//112KB
#define SRAM2_BASEADDR		0x20001C00U		//112 * 1024 = 114,688 bytes -> (hex)1C00
#define ROM					0x1FFF0000U		// aka "System Memory"
...
/*
 * Base addrs of peripherals which are hanging on AHB1 bus
 * TODO: Complete for all other peripherals
 */

#define GPIOA_BASEADDR			(APB1PERIPH_BASEADDR + 0x0000)	//(APB1PERIPH_BASEADDR + OFFSET)
...
/*
* Base addr of peripherals wich are hanging on APB1 bus
* TODO: Complete for all other peripherals
*/
...
/*
* Peripheral register definition structures (Refer to GPIO register map)
*/
typedef struct
{
	...
	__vo uint32_t AFR[2];	//Offset: AFRL-0x20, AFRH-0x24
}GPIO_RegDef_t;
 ...
 */
#define GPIOA_PCLK_EN()		(RCC->AHB1ENR |= (1 << 0))	//Set bit 0 of the AHB1ENR register inside RCC periph to 1
