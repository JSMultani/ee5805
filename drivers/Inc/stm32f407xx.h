 ...
 * Only the peripherals used by the current driver set are listed here.
 */
...
/*
 *  Macros to reset USARTx/UARTx peripherals
 */
 ...
 * Only the interrupt numbers needed by the current driver set are listed here.
 */
